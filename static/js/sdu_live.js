    ...
    const requestTempProbeReading = function() {
        ...
        .then(function(response) {
            try {
                ...
                document.getElementById('sd_temp').innerHTML = "XX";
                document.getElementById('sd_temp').setAttribute("class", "style_invalid");                
            }
        });
    }
    ...
    const requestRPMReading = function() {
        ...
        .then(function(response) {            
            try {
                ...
                document.getElementById('sd_rpm').innerHTML = "XX";
                document.getElementById('sd_rpm').setAttribute("class", "style_invalid");                
            }
        });
    }
